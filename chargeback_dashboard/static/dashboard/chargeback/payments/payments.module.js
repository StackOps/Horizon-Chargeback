...
(function() {
  ...
  function config($provide, $windowProvider, $routeProvider, $locationProvider) {
    ...
    .when(href + 'payments/', {
      ...
      controller: 'horizon.dashboard.chargeback.payments.PaymentsController',
      controllerAs : 'ctrl',
      resolve : {
        statusValor : ['horizon.app.core.openstack-service-api.chargeback',
        function(chargebackAPI){
          return chargebackAPI.getStatus();
        }],
        currentAccount : ['horizon.app.core.openstack-service-api.chargeback',
        function(chargebackAPI){
